...
const Gallery = () => {
    return (
        <div className="bg-gray-400 py-8 rounded-t-3xl border-t-8 border-violet-600">
            <div className="container mx-auto px-3 md:px-0 my-12 ">
                <h2 className="text-center text-4xl font-bold mb-2">Gallery</h2>
                <div className="w-16 m-auto border-t-2 mb-10 border-error"></div>
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
                    <div data-aos="flip-right" data-aos-duration="3000" className="relative overflow-hidden rounded-xl">
                    ...
                    <div data-aos="flip-left" data-aos-duration="3000" className="relative overflow-hidden rounded-xl">
